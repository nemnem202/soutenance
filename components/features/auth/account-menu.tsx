...
export function AccountMenuContent() {
  ...
  return (
    <DropdownMenuContent className="bg-background p-0 z-1 max-h-[var(--radix-dropdown-menu-content-available-height)] max-w-[var(--radix-dropdown-menu-content-available-width)] overflow-y-auto">
      {currentContent === "main" && (
        <MainContent
