...
export function Input({
  ...
  const inputClassName = cn(
    "h-8.5 w-full min-w-0 rounded-[inherit] px-[calc(--spacing(3)-1px)] outline-none [transition:background-color_5000000s_ease-in-out_0s] placeholder:text-muted-foreground/72 sm:h-7.5",
    "py-0 text-foreground! autofill:text-foreground! autofill:[-webkit-text-fill-color:var(--foreground)]",
