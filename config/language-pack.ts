...
export const languagePack: Record<string, Record<Language, string>> = {
  ...
  account_description: {
    fr: "Gérez votre profil et vos informations personnelles",
    en: "Manage your profile and personal information",
    es: "Gestiona tu perfil e información personal",
    de: "Verwalte dein Profil und persönliche Informationen",
    zh: "管理您的个人资料和个人信息",
  },
  profile_picture: {
    fr: "Photo de profil",
  ...
  profile_picture_description: {
    fr: "Cliquez pour changer votre photo",
    en: "Click to update your photo",
    es: "Haz clic para actualizar tu foto",
    de: "Klicke, um dein Foto zu ändern",
    zh: "点击更换头像",
  },
  session: {
    fr: "Session",
  ...
  session_description: {
    fr: "Gérez les accès à votre compte",
    en: "Manage access to your account",
    es: "Gestiona el acceso a tu cuenta",
    de: "Zugriff auf dein Konto verwalten",
    zh: "管理账号访问权限",
  },
  danger_zone: {
    fr: "Zone de danger",
  ...
  danger_zone_description: {
    fr: "Ces actions sont irréversibles, procédez avec précaution",
    en: "These actions are irreversible, proceed with caution",
    es: "Estas acciones son irreversibles, procede con cuidado",
    de: "Diese Aktionen sind unwiderruflich, vorsichtig vorgehen",
    zh: "这些操作不可撤销，请谨慎操作",
  },
  remove_account_description: {
    fr: "Supprime définitivement votre compte et toutes vos données",
    en: "Permanently deletes your account and all associated data",
    es: "Elimina permanentemente tu cuenta y todos los datos",
    de: "Löscht dein Konto und alle zugehörigen Daten dauerhaft",
    zh: "永久删除您的账号及所有相关数据",
  },
  appearance_description: {
    fr: "Personnalisez l'interface selon vos préférences",
    en: "Customize the interface to your preferences",
    es: "Personaliza la interfaz según tus preferencias",
